<div id="main-content">
  ...
  <div class="sub-feature" id="intro">
    ...
    <p id="try">Pasa sobre la imagen para probar y clic para aplicar</p>
    ...
    <ul id="personas-link" class="link">
      <li>
          <a href="http://www.getpersonas.com/en-US/gallery/" id="see-all-personas">Ve las más de <?=$personasnumber?></a>
      </li>
    </ul>
</div>
  ...
  <div class="sub-feature<?=$oop_class;?>" id="personalize"><div>
    <h2>Otras formas de personalizar</h2>
     <p>Adapta Firefox a tu manera de navegar con miles de complementos gratuitos.</p>
    <ul class="link">
      <li>
          <a href="https://addons.mozilla.org/<?=$lang?>/firefox/">Explora los complementos</a>
      </li>
    </ul>
  </div></div>
...
<div>
  ...
  <p id="sub-links">
      ...
      <a href="http://www.mozilla-hispano.org/documentacion/" id="support-link">Soporte de Firefox</a>
  </p>
