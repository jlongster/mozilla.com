...
<div id="main-content">
  ...
  <div class="sub-feature" id="intro">
    ...
    <ul id="personas-link" class="link">
      <li>
          <a href="http://www.getpersonas.com/en-US/gallery/" id="see-all-personas">See all <?=$personasnumber?>+</a>
      </li>
    </ul>
</div>
  ...
  <div class="sub-feature<?=$oop_class;?>" id="personalize"><div>
    <h2>More Ways to Personalize</h2>
    <p>Adapt Firefox to the way you browse with 1,000s of free add-ons.</p>
    <ul class="link">
      <li>
          <a href="https://addons.mozilla.org/<?=$lang?>/firefox/">Explore Add-ons</a>
      </li>
    </ul>
  </div></div>
...
<div>
  ...
  <p id="sub-links">
      <a href="http://www.mozilla-europe.org/en/firefox/features/" id="features-link">More Firefox 3.6 Features</a>
