<div id="sidebar">
	...
	<div class="sidebar-section">
		...
		<p>Fans around the world make Firefox and Mozilla a success! Take a minute to help.<br /><a href="/<?=$lang?>/about/participate/">Find Out How »</a></p>
	</div>
	<div class="sidebar-section">
		<h4>Other Resources &amp; Links</h4>
		<p>The following resources contain additional useful information about Firefox 4:</p>
		<ul class="spaced">
		  ...
		  <li><a href="https://developer.mozilla.org/en/Firefox_4.0_for_developers">Developer Information</a></li>
