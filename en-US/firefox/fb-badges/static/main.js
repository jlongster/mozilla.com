(function($) {
    ...
    $(function() {
        var v = $("#downloadButton").click(function() {
            top.location = "http://www.mozilla.org/?WT.mc_id=b15&WT.mc_ev=click";
            return;
            ...
            if(os) {
                var url = "http://www.mozilla.org/products/download.html?product=firefox-4.0rc1";
                    url += "&os=" + os;
                    url += "&lang=" + navigator.language;
                top.location =  url;
            } else {
                top.location = "http://www.mozilla.org/";
            }
        }).find("#buttonVersion");
