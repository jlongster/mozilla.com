...
$productionQuality = array('ar', 'cs', 'de', 'el', 'eo', 'es-AR','es-CL', 'es-ES','es-MX', 'et', 'eu', 'fa', 'fi', 'fr', 'fy-NL', 'ga-IE', 'gl', 'he', 'hr', 'hu', 'id', 'is', 'it', 'ko', 'lt', 'mr', 'nb-NO', 'nl', 'pa-IN', 'pl', 'pt-BR', 'pt-PT', 'rm', 'ro', 'ru', 'si', 'sk', 'sl', 'sq', 'sr', 'sv-SE', 'te', 'tr', 'uk', 'vi', 'zh-CN', 'zh-TW');
