...
if(array_key_exists($lang, $slogan2)) {

    $finalslogan = strip_tags($slogan2[$lang]);
...
$promobox = <<<PROMO
    ...
    <div id="screenshot"><div id="shade"></div><a href="https://addons.mozilla.org/{$lang}/firefox/"><img src="/img/l10n/diagram.png" /></a></div>
PROMO;
