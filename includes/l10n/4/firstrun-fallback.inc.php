...
$logo      = '<h2><img src="'.$logolink.'" alt="Firefox Logo" id="title-logo" /><img src="/img/l10n/fx4-wordmark.png" alt="Firefox Logo" id="title-wordmark" /></h2>';
...
'ak'    => 'Thanks for choosing Firefox! To get the most out of your browser, learn more about the <a>latest features</a>.',
...
'el'    => 'Σας ευχαριστούμε που επιλέξατε τον! Για να εκμεταλλευτείτε πλήρως την εφαρμογή, διαβάστε περισσότερα για τις <a>νέες λειτουργίες</a>.',
...
'lg'    => 'Webale kulonda Firefox! Okufuna omuwendo ogwa wagulu, manya ebisingawo ku <a>byekola ebibya</a>.',
