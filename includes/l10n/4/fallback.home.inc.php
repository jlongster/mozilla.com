...
<div id="main-content">
    ...
    <div class="sub-feature first">
        ...
        <p><?php e__('Check out the new look and feel of Firefox.');?><a href="/<?=$lang?>/firefox/features/"><?php e__('Learn More');?></a></p>
    </div>

    <div class="sub-feature">
        <h3><?php e__('Add-ons');?></h3>
        <p><?php e__('Customize with Add-ons');?><a href="/<?=$lang?>/firefox/customize/"><?php e__('Learn More');?></a>
        </p>
    </div>
...
?>
        ...
        <p><?=$main_slogan;?><a href="/<?=$lang?>/mobile/"><?php e__('Learn More');?></a>
        </p>
    </div>
