...
$brand_aware_locales = array('ar', 'as', 'be', 'bn-IN', 'br', 'ca', 'cs', 'cy', 'de', 'el', 'eo', 'es-AR', 'es-CL', 'es-ES', 'es-MX', 'et', 'eu', 'ff', 'fr', 'ga-IE', 'gd', 'gl', 'he', 'hr', 'hu', 'is', 'it', 'ko', 'lt', 'lv', 'mk', 'nb-NO', 'nl', 'pl', 'pt-BR', 'rm', 'ro', 'ru', 'si', 'sl', 'sq', 'sv-SE', 'th', 'tr', 'vi', 'zh-CN', 'zh-TW');
