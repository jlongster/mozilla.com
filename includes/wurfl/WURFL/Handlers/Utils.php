...
class WURFL_Handlers_Utils {
	...
	private static $mobileBrowsers = array("Tablet", "Mobile", "Wireless", "Palm", "Blazer", "NetFront", "Symbian", "Bolt", "Iris");
	...
	public static function indexOfOrLength($string, $target, $startingIndex) {
		$lengh = strlen($string);
