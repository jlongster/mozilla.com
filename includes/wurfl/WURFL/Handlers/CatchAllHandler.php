...
class WURFL_Handlers_CatchAllHandler extends WURFL_Handlers_Handler {
	...
	private function loadMozillaData() {
		$this->mozilla4UserAgentsWithDeviceID = $this->persistenceProvider->find(CatchAllUserAgentHandler::MOZILLA4);
		$this->mozilla5UserAgentsWithDeviceID = $this->persistenceProvider->find(CatchAllUserAgentHandler::MOZILLA5);
	}
