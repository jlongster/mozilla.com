...
class WURFL_Handlers_WindowsCEHandler extends WURFL_Handlers_Handler {
	...
	public function canHandle($userAgent) {
		return WURFL_Handlers_Utils::checkIfContains($userAgent, "Mozilla/")
			&& WURFL_Handlers_Utils::checkIfContains($userAgent, "Windows CE");
	}
	...
	function lookForMatchingUserAgent($userAgent) {	
		return WURFL_Handlers_Utils::ldMatch(array_keys($this->userAgentsWithDeviceID), $userAgent,
			self::TOLLERANCE);
	}
