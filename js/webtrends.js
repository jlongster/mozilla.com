...
// Created: 12/1/2010 6:46:59 PM
// Customized by Wes Contreras, 12/3/2010, customizations identified with "WC:"

// WC: Constructor now accepts parameters for dcsid, fpcdom, and sampling rate
// Sample usage: var _tag=new WebTrends({"dcsid":"dcsf9nqmj10000clgc14f05rf_2u7t","rate":50,"fpcdom":"mozilla.com"});
function WebTrends(options){
	var that=this;
	// begin: user modifiable
	// WC: Define values based on inputs
...
WebTrends.prototype.dcsTag=function(){
	// WC: Check to see if hit meets sampling criteria; if excluded by criteria, do not fire
	if (document.cookie.indexOf("WTLOPTOUT=")!=-1 || !this.dcsChk()){
		return;
	}
	// End customization
	var WT=this.WT;
...
WebTrends.prototype.dcsCollect=function(){
    if (this.enabled){
        ...
        this.dcsMeta();
        this.dcsAdv();
        // WC: Adding custom dcsBounce function to easily identify bounces
        this.dcsBounce();
        // End customization
...
// WC: Custom bounce identification, code written by unknown author
...
// WC: Sampling code written by Dan Bohling
